            ...
            <div class="panel panel-info text-center">
                ...
                <div class="panel-body">
                    <form id="login" method="post" action="loginform.php">
                        <?php if(isset($_SESSION['generalError'])) { echo $_SESSION['generalError'] ; unset($_SESSION['generalError']);} ?>
                        <input name="username" type="text" placeholder="Username" class="input pass" required="required" autofocus="autofocus"/>
                        <?php if(isset($_SESSION['usernameErrorLogin'])) { echo $_SESSION['usernameErrorLogin'] ; unset($_SESSION['usernameErrorLogin']);} ?>
                        <input name="passwort" type="password" placeholder="Password" required="required"
                               class="input pass" autofocus="autofocus"/>
                        <?php if(isset( $_SESSION['pwdErrorLogin'])) { echo  $_SESSION['pwdErrorLogin'] ; unset($_SESSION['pwdErrorLogin']);} ?>
                        <div class="checkbox">
                            <label>
            ...
            <div class="panel panel-info text-center">
                ...
                <div class="panel-body">
                    <form id="register" method="post" action=register.php>
                        ...
                        <input name="passwort" type="password" placeholder="Choose a secure password" required="required"
